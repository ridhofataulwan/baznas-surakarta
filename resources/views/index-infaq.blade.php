    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-12 text-center">
                <div>&nbsp;</div>
                <div>&nbsp;</div>
                <h2 class="text" style="color: #01502D;">KALKULATOR INFAQ BULANAN</h2>
                <div class="row">
                    <div class="col-md-6 mt-5">
                        <div class="card">
                            <div class="card-body" style="background-color: #01502D;">
                                <h5 class="card-title" style="color:white; text-align: left;"><b>Komponen Infaq</b>
                                </h5>
                                <div>&nbsp;</div>
                                <p class="card-text" style="color: white; text-align: left;">Silahkan diisi sesuai
                                    dengan gaji anda perbulan</p>
                                <div>&nbsp;</div>
                                <form action="{{ url('index-infaq') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <p class="card-text" style="color: white; text-align: left;">Besaran Infaq
                                        Perbulan</p>
                                    <div class="col-auto">
                                        <div class="input-group">
                    ...
                    <div class="col-md-6 mt-5">
                        <div class="container">
                            ...
                            <select class="form-select" id="autoSizingSelect" onchange="location = this.value;">
                                ...
                                <option value="{{ url('/index-infaq') }}" selected>Infaq</option>
                            </select>
                            </select>
                            <div>&nbsp;</div>
                            <h6 style="color: black; text-align: left;"><b>INFAQ</b></h6>
                            <p style="color: black; text-align: justify; font-size: clamp(13px, 1vw, 17px);">
                                Infaq sebenarnya diambil dari kata anfaqa-yunfiqu yang artinya membelanjakan atau
                                membiayai. Sementara itu, menurut Kamus Besar Bahasa Indonesia, infaq adalah upaya
                                mengeluarkan harta yang mencakup zakat dan non zakat.
                            <h6 style="color: black; text-align: left;"><b>Nilai Infaq Perbulan</b></h6>
                            @if (session('total'))
                            <div class="col-auto">
                                <div class="input-group">
                                    <div class="input-group-text">Rp</div>
