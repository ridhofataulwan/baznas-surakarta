    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-12 text-center">
                <div>&nbsp;</div>
                <div>&nbsp;</div>
                <h2 class="text" style="color: #01502D;">KALKULATOR ZAKAT MAAL</h2>
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body" style="background-color: #01502D;">
                                ...
                                <p class="card-text" style="color: white; text-align: left;">Silahkan diisi sesuai
                                    dengan gaji anda perbulan</p>
                                <div>&nbsp;</div>
                                <form action="{{ url('index-maal') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <p class="card-text" style="color: white; text-align: left;">Gaji Pokok Perbulan
                                    </p>
                                    <div class="col-auto">
                                    ...
                                    <p class="card-text" style="color: white; text-align: left;">Tunjangan Tambahan
                                    </p>
                                    <div class="col-auto">
                                        <div class="input-group">
                                            <div class="input-group-text">Rp</div>
                                    ...
                                    <p class="card-text" style="color: white; text-align: left;">Hutang/Cicilan
                                    </p>
                                    <div class="col-auto">
                                        <div class="input-group">
                                            <div class="input-group-text">Rp</div>
                                    ...
                                    <p class="card-text" style="color: white; text-align: left;">Besaran Zakat
                                        Maal</p>
                                    <div class="col-auto">
                                        <div class="input-group">
                    ...
                    <div class="col-md-6 mt-5">
                        <div class="container">
                            ...
                            <select class="form-select" id="autoSizingSelect" onchange="location = this.value;">
                                ...
                                <option value="{{ url('/index-maal') }}" selected>Zakat Maal</option>
                            ...
                            <p style="color: black; text-align: justify; font-size: clamp(13px, 1vw, 17px);">
                                Pengertian zakat mal adalah sebagian harta kekayaan seseorang atau badan hukum yang
                                wajib dikeluarkan untuk diberikan kepada golongan khusus, dalam jangka waktu dan
                                jumlah nominal tertentu.
                                <br>
                                Berdasarkan Badan Amil Zakat Nasional (BAZNAS), istilah kata mal berasal dari bahasa
                                Arab yang artinya adalah harta atau kekayaan. Dengan kata lain, segala sesuatu hal
                                untuk disimpan dan dimiliki oleh seseorang.
                            </p>
                            <h6 style="color: black; text-align: left;"><b>Nilai Zakat Mal</b></h6>
                            @if (session('total'))
                            <div class="col-auto">
                                <div class="input-group">
                                    <div class="input-group-text">Rp</div>
