    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-12 text-center">
                <div>&nbsp;</div>
                <div>&nbsp;</div>
                <h2 class="text" style="color: #01502D;">KALKULATOR BIAYA QURBAN</h2>
                <div class="row">
                    <div class="col-md-6 mt-5">
                        <div class="card">
                            <div class="card-body" style="background-color: #01502D;">
                                <h5 class="card-title" style="color:white; text-align: left;"><b>Komponen Qurban</b>
                                </h5>
                                <div>&nbsp;</div>
                                <p class="card-text" style="color: white; text-align: left;">Silahkan diisi sesuai
                                    dengan kemampuan anda</p>
                                <div>&nbsp;</div>
                                <form action="{{ url('index-qurban') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <p class="card-text" style="color: white; text-align: left;">Pilih Jenis Qurban
                                    </p>
                                    <div class="col-auto">
                    ...
                    <div class="col-md-6 mt-5">
                        <div class="container">
                            ...
                            <select class="form-select" id="autoSizingSelect" onchange="location = this.value;">
                                ...
                                <option value="{{ url('/index-qurban') }}" selected>Qurban</option>
                                <option value="{{ url('/index-infaq') }}">Infaq</option>
                            </select>
                            <div>&nbsp;</div>
                            <h6 style="color: black; text-align: left;"><b>Qurban</b></h6>
                            <p style="color: black; text-align: justify; font-size: clamp(13px, 1vw, 17px);">Qurban
                                berasal dari bahasa Arab, “Qurban” yang berarti dekat (قربان). Kurban dalam Islam
                                juga disebut dengan al-udhhiyyah dan adh-dhahiyyah yang berarti binatang sembelihan,
                                seperti unta, sapi (kerbau), dan kambing yang disembelih pada hari raya Idul Adha
                                dan hari-hari tasyriq sebagai bentuk taqarrub atau mendekatkan diri kepada Allah.
                            </p>
                            <h6 style="color: black; text-align: left;"><b>Nilai Qurban</b></h6>
                            @if (session('total'))
                            <div class="col-auto">
                                <div class="input-group">
                                    <div class="input-group-text">Rp</div>
