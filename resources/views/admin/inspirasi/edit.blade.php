                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form action="{{ url('admin/inspirasi/update/'.$inspirasi->id) }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="old_image" value="{{ $inspirasi->gambar }}">
                                            <div class="form-group row mb-4">
                                                <label
                                                    class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Judul</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" class="form-control" name="judul" value="{{ $inspirasi->judul }}">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <textarea style="height: 150px;" name="deskripsi" class="form-control summernote-simple">{{ $inspirasi->deskripsi }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    ...
                                                    <img src="{{ asset($inspirasi->gambar) }}" alt=""
