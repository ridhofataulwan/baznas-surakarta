                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ url('admin/galeri/update/'.$galeri->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="row-sm-12 row-md-4" id="image-edit">
                                                        <div class="image-preview" height="100%">
                                                            ...
                                                            <input type="file" name="gambar[]" id="image-upload" value="/{{$galeri->gambar}}" multiple>
                                                            <img src="/{{$galeri->gambar}}" id="image-preview" width="100%" height="auto">
                                                        </div>
                                                    </div>
                                                    @error('gambar')
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="image-modal-label">{{$galeri->judul}}</h5>
