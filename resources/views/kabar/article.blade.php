        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-4 col-md-4 col-12" style="padding: 2%;">
                <div class="card shadow rounded">
                    ...
                    <div class="card-body">
                        <a href="{{url('article-detail/'.$b->id)}}" class="font-highlight" style="text-align: left; color: #2E3192">{{ $b->judul }}
                        </a>
                        <p class="card-text">
                            {!! \Illuminate\Support\Str::words($b->deskripsi, 10, $end='...') !!}
                        </p>
                        <a href="{{url('article-detail/'.$b->id)}}" class="btn btn-primary" style="float:right; border-radius: 30px; font-size:clamp(10px, 1vw, 18px);">Selengkapnya</a>
                    </div>
                </div>
            </div>
            @endif
