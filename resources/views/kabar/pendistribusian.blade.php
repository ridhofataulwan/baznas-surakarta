        ...
        <div class="row">
            <div class="mb-4 col-sm-12 col-lg-4 col-md-4">
                <div class="card" style="max-height: 400px;">
                    <img src="assets/img/baznas.jpeg" class="card-img-top" alt="" style="background-color: #FF9900; min-height: 250px; max-height: 300px;">
            ...
            <div class="mb-4 col-sm-12 col-lg-4 col-md-4">
                <div class="card" style="max-height: 400px;">
                    <img src="assets/img/zakat.jpg" class="card-img-top" alt="" style="background-color: #FF9900; min-height: 250px; max-height: 300px;">
                    <div class="card-body" style="background-color: #FF9900;">
            ...
            <div class="mb-4 col-sm-12 col-lg-4 col-md-4">
                <div class="card" style="max-height: 400px;">
                    <img src="assets/img/infaq.jpg" class="card-img-top" alt="" style="background-color: #FF9900; min-height: 250px; max-height: 300px;">
                    <div class="card-body" style="background-color: #FF9900;">
