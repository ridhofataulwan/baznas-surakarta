    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-12 text-center">
                <div>&nbsp;</div>
                <div>&nbsp;</div>
                <h2 class="text" style="color: #01502D;">KALKULATOR ZAKAT FIDYAH</h2>
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body" style="background-color: #01502D;">
                                ...
                                <p class="card-text" style="color: white; text-align: left;">Silahkan diisi sesuai
                                    dengan hutang puasa anda</p>
                                <div>&nbsp;</div>
                                <form action="{{ url('index-fidyah') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <p class="card-text" style="color: white; text-align: left;">Total hari tidak
                                        berpuasa</p>
                                    <div class="col-auto">
                                    ...
                                    <div class="col-auto">
                                        <div class="input-group">
                                            ...
                                            <input type="number" min="1" class="form-control" id="autoSizingInputGroup" name="jiwa">
                                        </div>
                                    </div>
                                    <p class="card-text" style="color: white; text-align: left;">Harga Zakat Fidyah
                                        (Per hari dan Per jiwa)</p>
                                    <div class="col-auto">
                                        <div class="input-group">
                    ...
                    <div class="col-md-6 mt-5">
                        <div class="container">
                            ...
                            <select class="form-select" id="autoSizingSelect" onchange="location = this.value;">
                                ...
                                <option value="{{ url('/index-fidyah') }}" selected>Zakat Fidyah</option>
                            ...
                            <p style="color: black; text-align: justify; font-size: clamp(13px, 1vw, 17px);">Secara
                                bahasa, fidyah berarti menebus atau mengganti. Secara syariat, fidyah bermakna denda
                                yang wajib ditunaikan seorang muslim ketika mereka melakukan hal yang dilarang atau
                                meninggalkan hal yang diwajibkan.

                                Salah satu penunaian fidyah yang paling lazim adalah sebagai penebus puasa Ramadan.
                                Fidyah puasa bernilai 1 mud dan wajib ditunaikan oleh mereka yang tidak dapat
                                membayar dengan puasa atau kehabisan waktu untuk bayar puasa.</p>
                            <h6 style="color: black; text-align: left;"><b>Nilai Zakat Fidyah</b></h6>
                            @if (session('total'))
                            <div class="col-auto">
                                <div class="input-group">
                                    <div class="input-group-text">Rp</div>
