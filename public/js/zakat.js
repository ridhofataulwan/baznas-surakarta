...
function handleClick(number) {
    ...
    document.getElementById("alert").innerHTML =
        "Nomor Rekening <b>" + number + "</b> telah tersalin!";
}
...
$(document).on("click", ".btn-check", function () {
    ...
    var output =
        ...
        '<img src="' +
        image1 +
        '" alt="pembayaran perbankan" class="image-layanan">' +
        '<h4 class="mb-4 mt-5 header-layanan">' +
        layanan2 +
        "</h4>" +
        ...
        '" style="' +
        style +
        '" height="150px" alt="pembayaran perbankan" class="image-layanan mx-1">' +
        "</div>" +
        '<div class="col-md-auto">' +
        '<img src="' +
        image3 +
...
function countChars(obj) {
    ...
    if (obj.value == "") {
        ...
        document.getElementById("nik").innerHTML =
            'NIK <span class="text-danger">*</span> <span class="text-danger"> [' +
            strLength +
            "/" +
            maxLength +
            "] </span>";
